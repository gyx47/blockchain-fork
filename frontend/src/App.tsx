...
function App() {
    ...
    const [newActivityOptions, setNewActivityOptions] = useState(''); // Comma-separated
    const [newActivityEndTime, setNewActivityEndTime] = useState(''); // Date string
    const [newActivityPool, setNewActivityPool] = useState(''); // ETH
    const [buyTicketActivityId, setBuyTicketActivityId] = useState('');
    const [buyTicketOptionIndex, setBuyTicketOptionIndex] = useState('');
    const [buyTicketAmount, setBuyTicketAmount] = useState(''); // ETH
    const [listTicketId, setListTicketId] = useState('');
    const [listTicketPrice, setListTicketPrice] = useState(''); // ETH
    const [settleActivityId, setSettleActivityId] = useState('');
    const [settleWinningOption, setSettleWinningOption] = useState('');
